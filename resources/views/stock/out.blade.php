@extends('layouts.app')
@section('title', 'Stok Çıkışı')
@section('content')
<div class="max-w-2xl mx-auto">
    <h1 class="text-2xl font-bold text-gray-800 mb-6">Stok Çıkışı</h1>
    <form action="{{ route('stock.out.store') }}" method="POST" class="bg-white rounded-lg shadow p-6">
        @csrf
        <div class="space-y-4">
            <div>
        ...
        <div class="flex justify-end space-x-3 mt-6">
            ...
            <button type="submit" class="px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700">Stok Çıkışı Yap</button>
        </div>
    </form>
</div>
@endsection
